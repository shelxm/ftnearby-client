...
const FavoriteButton = ({foodTruck, onUpdated}) => {
    ...
    async function handleOnFavorite() {
        ...
        console.log("favorited happened successfully");
        await onUpdated();
    }

    async function handleRemoveFavorite() {
        console.log('I am the delete function')
        await axios.delete(API + "user/favorites/" + foodTruck._id, {headers: {
            Authorization: `Bearer ${token}`,
        }});
    ...
    return (foodTruck.isFavorite ? (
                ...
                <button className="btn" onClick={handleOnFavorite}>
